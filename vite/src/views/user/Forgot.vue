	...
	<div class="container my-3">
		<div class="row">
			<div class="col-md-6 mx-auto">
			  ...
			  <button class="btn btn-primary" :disabled="loading" @click="resetPassword()">重新設定新密碼</button>
		  </div>
		</div>
	</div>
</template>
...
function resetPassword() {
	...
	loading.value = true
	axios.post('/user/reset-password', formData.value).then(response => {
		formValid.value = {
			fails: false
		}
